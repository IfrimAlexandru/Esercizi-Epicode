package it.epicode.EsercizioS1G3;

import it.epicode.EsercizioS1G3.bean.Menu;
import it.epicode.EsercizioS1G3.bean.Ordine;
import it.epicode.EsercizioS1G3.enumerators.StatoOrdine;
import it.epicode.EsercizioS1G3.bean.Tavolo;
...
public class NewCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ApplicationContext ctx = new AnnotationConfigApplicationContext(EsercizioS1G3Application.class);
