...
import it.epicode.EsercizioS1G2.bean.Ordine;
import it.epicode.EsercizioS1G2.enumerators.StatoOrdine;
import it.epicode.EsercizioS1G2.bean.Tavolo;
...
public class NewCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ApplicationContext ctx = new AnnotationConfigApplicationContext(EsercizioS1G2Application.class);
